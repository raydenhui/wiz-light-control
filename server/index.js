...
async function handleShutdown(isServiceStop = false) {
  ...
  console.log('Note: Lights will be handled by system shutdown scheduled task');
...
const startServer = async () => {
  server.listen(PORT, async () => {
    ...
    console.log('WizLight Control service is ready');
    console.log('Note: Lights will automatically turn on/off with system startup/shutdown via scheduled tasks');
  });
};
